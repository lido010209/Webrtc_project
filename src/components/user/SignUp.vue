<template>
  <div class="container-fluid d-flex flex-wrap justify-content-center mt-3">
    <div class="border border-primary rounded bg-white shadow-lg col-12 col-md-7 pb-3">
      <h1 class="w-100 text-center text-white" style="background-color: darkblue">
        회원가입
      </h1>
      <form @submit.prevent="formSignup" class="w-100 ps-3 pe-3">
        ...
        <br />
        <a href="/connect/login" class="w-100 link-secondary"
          >이미 회원이신가요?</a
        >
        <br /><br />
